...
module.exports = async (deployer, network, [defaultAccount]) => {
  ...
  if (network.startsWith('rinkeby')) {
    await deployer.deploy(Sector7slums, RINKEBY_VRF_COORDINATOR, RINKEBY_LINKTOKEN, RINKEBY_KEYHASH)
    let s7s = await Sector7slums.deployed()
    ...
    // await deployer.deploy(Sector7slums)
    // let s7s = await Sector7slums.deployed()
  }
}
